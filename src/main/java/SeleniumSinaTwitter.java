...
public class SeleniumSinaTwitter {
  ...
  public static void login(WebDriver driver) throws Exception {
    ...
    keyWord.clear();
    keyWord.sendKeys("zuo.zhong@163.com");
    keyWord = driver.findElement(By.xpath("//input[@name='password']"));
    keyWord.clear();
    keyWord.sendKeys("jik920717");
    try {
    ...
    try {
      ...
      if (keyWord != null) {
        ...
        System.out.println("验证码地址 =====" + src);
        if (src != null && !"".equals(src)) {
          snapshot2(driver, "sanpshot_fullscron.png");

          BufferedImage inputbig = createElementImage(driver, keyWord);
          ImageIO.write(inputbig, "png", new File("snapshot.png"));
  ...
  public static void main(String[] args) throws Exception {
    ...
    String URL = "http://weibo.com/comment/outbox";//http://coral.qq.com/1008591939
    ...
    WebDriver driver = new RemoteWebDriver(new URL("http://localhost:9515"), capability);
